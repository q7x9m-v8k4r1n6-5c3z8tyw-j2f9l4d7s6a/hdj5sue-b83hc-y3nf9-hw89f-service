...
public interface IRaceCardService
{
    ...
    Task<CardUseResponse> UseAsync(Guid raceId, Guid teamId, Guid cardInstanceId, IReadOnlyDictionary<string, string> inputs, CancellationToken cancellationToken = default);
